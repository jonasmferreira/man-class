<?php
$path_root_ConfigCkfinder = dirname(__FILE__);
$DS = DIRECTORY_SEPARATOR;
$path_root_ConfigCkfinder = "{$path_root_ConfigCkfinder}{$DS}..{$DS}..{$DS}";
require_once "{$path_root_ConfigCkfinder}admin{$DS}class{$DS}configuracao.class.php";
...
*/
$baseUrl = $configuracao['configuracao_baseurl_ckfinder'];
...
ATTENTION: The trailing slash is required.
*/
$baseDir = "{$path_root_ConfigCkfinder}imgs_rich{$DS}";
